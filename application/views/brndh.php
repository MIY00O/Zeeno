...
<body>
    ...
    <div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="owl-carousel header-carousel position-relative">
            <?php $no = 1; foreach ($caraousel as $ac) { ?>
                <div class="owl-carousel-item position-relative" data-dot="<img src='<?= base_url('assets/upload/caraousel/' . $ac['foto']); ?>'>" >
                    <img class="img-fluid" style="height:80vh; object-fit:cover;" src="<?= base_url('assets/upload/caraousel/' . $ac['foto']); ?>">
                    <div class="owl-carousel-inner">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    <h1 class="display-2 text-white animated slideInDown"><?= $ac['judul'] ?></h1>
                                    <p class="fs-5 fw-medium text-white mb-4 pb-3"><?= $ac['judul'] ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="mb-4">KONTEN KOLABORASI</h1>
            </div>
            <div class="row g-4">
